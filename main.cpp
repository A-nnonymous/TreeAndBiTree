...
void main()
{
	...
	/*	BiNode* node1; node1 = (BiNode*)malloc(sizeof(BiNode));
		BiNode* node2; node2 = (BiNode*)malloc(sizeof(BiNode));
		BiNode* node3; node3 = (BiNode*)malloc(sizeof(BiNode));
		BiNode* node4; node4 = (BiNode*)malloc(sizeof(BiNode));
		BiNode* node5; node5 = (BiNode*)malloc(sizeof(BiNode));
		BiNode* node6; node6 = (BiNode*)malloc(sizeof(BiNode));
		BiNode* node7; node7 = (BiNode*)malloc(sizeof(BiNode));
		BiNode* node8; node8 = (BiNode*)malloc(sizeof(BiNode));
